...
router.route('/:id')
  ...
  .patch(authController.protect, authController.restrictTo('admin', 'lead-guide'), tourController.uploadTourImages, tourController.handleTourImages, tourController.updateTour)
